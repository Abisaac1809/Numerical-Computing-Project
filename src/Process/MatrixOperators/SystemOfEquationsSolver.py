...
class SystemOfEquationsSolver:
    ...
    def concatenateMatrixAndVector(self, matrix:np.ndarray, vector:np.ndarray) -> np.ndarray:
    ...
    def sortResultByPosition(self, resultVector: np.ndarray, positionVector: np.ndarray) -> np.ndarray:
